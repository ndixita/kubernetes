...
func NewMainKubelet(ctx context.Context,
	...
	oomWatcher, err := oomwatcher.NewWatcher(kubeDeps.Recorder, kubeDeps.ContainerManager.NewPodContainerManager())
	if err != nil {
...
func (kl *Kubelet) initializeModules(ctx context.Context) error {
	...
	metrics.RegisterCollectors(
		...
		collectors.NewCPUThrottlingCollector(kl.cadvisor, kl.containerManager.NewPodContainerManager()),
	)
